...
3. "document_type": Specific type (e.g., "Memorandum of Agreement", "Board Resolution", "Employment Contract", etc.)
4. "key_topics": Array of 3-5 main topics/keywords
5. "suggested_folder": IMPORTANT - Available folders: {$foldersList}. If one of these folders is appropriate for this document type, use it. However, if NONE of the existing folders match the document type well (e.g., Certificate of Employment should NOT go to "MODE OF AGREEMENT"), suggest a NEW descriptive folder name instead (e.g., "Employment Records", "Certificates", "HR Documents"). Do NOT use generic terms like "Legal Document" or "Documents".
6. "urgency": "high", "medium", or "low"
7. "requires_review": true/false - if document needs legal/compliance review
